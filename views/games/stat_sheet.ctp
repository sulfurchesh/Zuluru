...
<table>
	<tr>
		<td>Date &amp; time:</td>
		<td><?php echo $this->ZuluruTime->fulldatetime($game['GameSlot']['game_date'] . ' ' . $game['GameSlot']['game_start']); ?></td>
//		. ' - ' . $this->ZuluruTime->time($game['GameSlot']['display_game_end']); ?></td> <!-- XXX: game_end -->
	</tr>
	<tr>
		<td>Team:</td>
